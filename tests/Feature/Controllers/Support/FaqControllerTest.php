...
/**
 * HTTP smoke test for FaqController. The configured route group
 ...
 * @internal
 */
final class FaqControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/support/faqs');
    ...
    {
        $result = $this->get('/api/v1/support/faqs/99999');
