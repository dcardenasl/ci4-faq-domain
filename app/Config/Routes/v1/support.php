...
$routes->group('support', ['namespace' => '\App\Controllers\Api\V1\Support'], function ($routes): void {
    ...
    $routes->group('', ['filter' => ['domainauth', 'throttle']], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:faq-category.read'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:faq-category.write'], function ($routes): void {
        ...
        $routes->group('', ['filter' => 'permission:faq-category.delete'], function ($routes): void {
